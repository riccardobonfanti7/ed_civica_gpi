...
document.querySelectorAll('[data-fs]').forEach(wrap => {
  const btn = wrap.querySelector('.cs-expand');
  if (btn) btn.addEventListener('click', (e) => { e.stopPropagation(); openFullscreen(wrap); });
  wrap.addEventListener('click', (e) => {
    // Don't open fullscreen if clicking inside the slider itself
